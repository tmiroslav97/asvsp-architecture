...
class KafkaClient:
    ...
    def send(self, topic: str, value: str, key=None, response_length_override=None, name=None, context={}):
        ...
        self.producer.produce(topic, value.encode('utf-8'), callback=callback)
